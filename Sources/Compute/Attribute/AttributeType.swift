...
extension AGUnownedGraphContextRef {
    ...
    func internAttributeType(
        ...
        #if arch(wasm32)
        // WASI: call the C-imported AGGraphInternAttributeTypeC (declared in the
...
// existing swift_retain/release in AGRetainClosureC/AGReleaseClosure own its
